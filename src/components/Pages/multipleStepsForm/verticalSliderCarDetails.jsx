      ...
      <div className="customer-step-container">
        <div>
          ...
          >
            ...
            <div>
              <Typography variant="body1" className="loc-name-text-car-details">{locName}</Typography>
            </div>
          </Box>
        </div>
...
export default function CustomIconStepper() {
  return (
    <Box sx={{ width: "100%" }} className="customer-icon-stepper-container">
      ...
      <Stepper activeStep={steps.length - 1} orientation="vertical" className="pick-drop-data">
